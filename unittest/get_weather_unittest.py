...
good_location_units_imperial = Location("mexico city", "mx", "Imperial")
good_location_units_kelvin = Location("Rome", "It", "KELVIN")
good_location_units_empty_string = Location("sydney", "au", "")
city_with_hyphen_state_full_name = Location("Tel-Aviv", "IL")
